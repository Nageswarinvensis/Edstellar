...
const CATEGORIES = {
  "artificial-intelligence": {
    ...
    seo: {
      ...
      description: "Instructor-led corporate AI training across generative AI, machine learning, MLOps and governance. Scoped to your stack, delivered onsite or virtually in 100+ countries.",
      ogImage: null,
    },
    ...
    heading: {
      parts: [
        { text: "Most-requested " },
        { text: "AI training topics.", is_italic: true },
      ],
    },

    description: "A snapshot of where demand is concentrated across the AI training we are asked to run, from broad literacy that reaches every employee to the deep technical and governance work that runs models in production.",
  ...
  proposedSectors: [
    ...
    catalog: {
      ...
      courses: [
...

        {
          ...
          title:
            "Generative AI with Python Training",
      ...
      ctaBannerData: [
        {
          variant: "light",
          eyebrow: "",
          heading: "Training a role that is not listed, or a mix of them? Tell us who you are training and what they need to do, and we build the shortlist.",
    ...
    outcomes11Data : {
      ...
      description: "Domain-level outcomes, not course objectives. These are the capabilities L&D and engineering leaders are usually asked to evidence.",
      ...
      items: [
        {
          ...
          description: "Staff who know what to put into a model, what not to, and when a human has to decide.",
        },

        {
          ...
          description: "End-to-end delivery from problem framing and features through training, packaging, and release.",
        },

        {
          ...
          description: "Offline and online evaluation, benchmark design, red teaming, and honest reporting of limits.",
        },

        {
          ...
          description: "Drift detection, performance tracking, alerting, incident response, and retraining pipelines.",
        },

        {
          ...
          description: "Retrieval, agents, tool use, latency and cost control, and graceful degradation in real applications.",
        },

        {
          ...
          description: "Model inventory, risk classification, documented controls, and audit-ready evidence.",
        },

        {
          ...
          description: "ISO/IEC 42001 alignment, EU AI Act readiness, sector rules, and privacy-by-design for AI systems.",
        },

        {
          ...
          description: "Platform standards, reusable components, cost management, and an internal capability ladder.",
        },
      ],
    },
    governanceData : {
      ...
      tabs: [
...

        {
          ...
          description: "A voluntary framework structured around four functions: govern, map, measure and manage. It is not law, which is precisely why it has been adopted so widely as the working scaffolding for AI risk programs, including well outside the US.",
          points: [
            {
              title: "GOVERN",
              description: "Ownership, policy and accountability that survives staff turnover.",
            },
            {
              title: "MEASURE",
              description: "Evaluation that produces evidence rather than confidence.",
            },
            {
              title: "MANAGE",
              description: "A response path for when a model behaves badly in production.",
            },
          ],
        },

        {
          ...
          description: "An international management-system standard designed to help organizations establish, implement, maintain and continually improve responsible AI governance.",
          points: [
            {
              title: "GOVERN",
              description: "Establish policies, ownership and organizational responsibilities.",
            },
            {
              title: "MEASURE",
              description: "Monitor AI objectives, controls and performance through evidence.",
            },
            {
              title: "MANAGE",
              description: "Continuously improve the AI management system as risks evolve.",
            },
          ],
        },

        {
          ...
          description: "Guidance for organizations managing risks associated with artificial intelligence systems across planning, development, deployment and operational use.",
          points: [
            {
              title: "IDENTIFY",
              description: "Recognize AI-specific risks across the complete system lifecycle.",
            },
            {
              title: "EVALUATE",
              description: "Assess likelihood, impact and the effectiveness of risk controls.",
            },
            {
              title: "TREAT",
              description: "Apply proportionate actions to reduce and manage identified risks.",
            },
          ],
        },

        {
          ...
          description: "A data protection framework establishing requirements for processing personal data, with important implications for AI systems that collect, process or infer information about individuals.",
          points: [
            {
              title: "GOVERN",
              description: "Define accountability and lawful foundations for personal-data processing.",
            },
            {
              title: "MEASURE",
              description: "Assess privacy impact, controls and evidence around data processing.",
            },
            {
              title: "MANAGE",
              description: "Maintain appropriate safeguards throughout the AI system lifecycle.",
            },
          ],
        },

        {
          ...
          description: "Industry-specific requirements add another layer of governance where AI operates in regulated or high-impact environments.",
          points: [
            {
              title: "GOVERN",
              description: "Translate sector obligations into clear organizational ownership.",
            },
            {
              title: "MEASURE",
              description: "Create evidence that demonstrates compliance with applicable rules.",
            },
            {
              title: "MANAGE",
              description: "Embed regulatory controls into day-to-day AI operations.",
            },
          ],
        },
      ],
    ...
    trainers: {
      ...
      description: "Every trainer passes a technical domain assessment, a live delivery evaluation by a senior practitioner, and reference checks from past corporate cohorts. Nobody reaches a cohort on a CV alone.",
      people: [
        {
          name: "Daniel Roth",
    ...
    proof1Data : {
      ...
      description: "Three engagements across the portfolio: a literacy rollout, an engineering deep-dive, and a governance build.",

      items: [
        {
          id: "literacy-rollout",
          stat: "2,400",
          description: "Every employee went through AI awareness before we opened up the tools. Support tickets about “can I put this in the chatbot” basically stopped.",
          person: "HEAD OF L&D",
...

        {
          ...
          stat: "6 → 1",
          description: "Deployment used to take six weeks of hand-offs. After the MLOps and monitoring programs the team rebuilt the pipeline themselves and it takes one.",
...

        {
          id: "governance-track",
          stat: "42",
          description: "We came in with a spreadsheet of models nobody trusted. We left with a real inventory, risk tiers, and a control set our auditors accepted.",
    ...
    mapsectionData: {
      ...
      description: "Edstellar is a corporate training provider delivering instructor-led AI programs to teams of every size, from a single squad to an entire engineering organisation, on-site, virtual, or blended, with programs built and led by practitioners.",
      image: {
        src: "/course/map1.png",
    ...
    stages: [
      {
        ...
        number: "01",
        title: "Discover",
        description: "We meet your CTO and L&D team to baseline what your data, engineering and product people can actually do today, against the roles you need them to fill.",
        meta: "Week 1–2",
      },
      {
        id: "design",
        number: "02",
        title: "Design",
        description: "Programs are assembled against your model stack, your data, and the governance regime you operate under, then trainers are shortlisted from the vetted bench.",
        meta: "Week 2–4",
      },
      {
        id: "deliver",
        number: "03",
        title: "Deliver",
        description: "Closed-cohort instructor-led sessions in your language and timezone, with GPU sandboxes, notebooks and retrieval or agent environments shipped alongside.",
      ...
      },
      {
        ...
        number: "04",
        title: "Assess",
        description: "Pre and post technical assessments establish a measurable change in capability, benchmarked against role frameworks.",
      ...
      },
      {
        ...
        number: "05",
        title: "Sustain",
        description: "Retrospectives, refresher modules and skill-refresh tracking keep the investment from decaying, and the measured gaps feed the next cycle.",
        meta: "Quarterly",
      },
    ],
    ...
    items: [
      {
        ...
        description: "Psychometric, behavioral, leadership and 360-degree assessment.",
        href: "#",
      },
      {
      ...
      },
      {
        ...
        description: "Training outsourcing, vendor management, logistics and administration.",
        href: "#",
      },
      {
  ...
  ldData: {
    heading: {
      ...
      description: "The five stages above are what we run. This is the same month from your side: what you decide, what you bring, and what lands on your desk.",
    ...
    scopeData : {
      ...
      description: "Tell us roughly how many people need training and we'll show you the package this usually maps to. Nothing is fixed until we've scoped it with you.",
    ...
    relatedCategoriesData: {
      ...
      description: "AI capability rarely sits alone. These categories are the ones enterprises most often build alongside it.",

...
const CATEGORIES = {
  ...
  proposedSectors: [
    ...
    programData : {
      ...
      description: "A selection from the live catalog. Combine a discipline and a role to narrow it.",
      ...
      noResults: "No program matches that combination in this selection. The live catalog holds 130 AI programs, and we build custom programs where nothing fits.",
      actions: [
        {

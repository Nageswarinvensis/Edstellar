...
const DOMAIN_COURSES = {
  ...
  ctaBannerData : {
    ...
    capabilityDark: {
      variant: "dark",
      eyebrow: "AI CAPABILITY BUILDING",
      heading: "Build the AI capability your organization needs.",
      ctaText: "Explore AI Training Programs",
      ctaHref: "/corporate-training",
    },
  },
    ...
    marqueeData : {
      ...
      heading: {
        highlight: "Programs are designed around what you already run, not a reference architecture we prefer.",
      },
      description:"If your stack is not listed, it is almost certainly still covered.",
...
export const getCategorySlugs = cache(async () => Object.keys(DOMAIN_COURSES));

...
import learningStrategy from "@/content/learning development consulting/learning-strategy.json";
 ...
 * file in `content/` and one line here — the route, template and sitemap
 * pick it up from this map.
 */
const SERVICES = {
  "learning-development-consulting-services/learning-strategy": learningStrategy,
};

...
const CATEGORY_COURSES = {
  "ml-model-monitoring": {
    ...
    groupQuote: {
      ...
      description:
        "Answer three quick questions about team size, scope, and how often you need the program run. Your answers carry into the request form at the top of this page, so you only fill in your details once.",

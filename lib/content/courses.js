...
const CATEGORY_COURSES = {
  "ml-model-monitoring": {
    ...
    // Placeholder copy only — swap in real, sourced client testimonials
    // (with permission on record, per TASTE.md's claims policy) before this
    // section ships. No specific outcome numbers or company names are
    ...
    testimonials: {
      ...
      items: [
        {
          quote:
            "The hands-on labs gave our team a shared playbook for catching drift before it reached customers, not just the theory behind it.",
          name: "ML Platform Lead",
          role: "Enterprise SaaS",
        },
        {
          quote:
            "Our engineers walked in knowing model accuracy degrades and walked out with an actual monitoring stack they'd built themselves.",
          name: "Head of Data Science",
          role: "Financial services",
        },
        {
          quote:
            "Edstellar tailored the curriculum to our own production stack, so the labs mapped directly onto the systems our team maintains.",
          name: "MLOps Manager",

...
/**
 * `FAQPage` from the same `{ question, answer }` items the visible FAQ
...
/**
 * `Person` for a trainer profile page — only the facts the profile renders:
 * name, title, photo, home base and delivery languages.
 */

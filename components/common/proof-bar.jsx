            ...
            >
              <Box className="flex min-w-0 items-center gap-4 max-md:gap-3">
                ...
                <Box className="flex min-w-0 flex-col gap-1.5">
                  ...
                  <span className={LIGHT_LABEL_CLASS}>{trainers.label}</span>
                </Box>
              </Box>
            </Box>
          )}

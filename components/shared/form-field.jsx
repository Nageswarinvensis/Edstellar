 ...
 * the group-quote wizard's contact step). Distinct from `QuotePanel`'s own
 * `Field`, which hides the label and lets the placeholder carry it — that
 * form is a cramped sticky rail, these are full-width sections with room
 * for a real label.
 */

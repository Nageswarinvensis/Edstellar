...
const tailwindClasses = {
  h1: "font-display font-bold text-ink text-[clamp(38px,3.5vw,48px)] leading-[1.05] tracking-[-0.035em] break-words hyphens-auto",
  h2: "font-display font-bold text-ink text-[clamp(32px,3.2vw,40px)] leading-[1.08] tracking-[-0.03em] break-words hyphens-auto",

 ...
 */
function VendorHero({ hero, breadcrumbs, proof }) {
  if (!hero) return null;
  ...
  return (
    ...
    >
      <Box className="container-page">
        ...
        <Reveal delay={4}>
          <TopicPills topics={hero.topics} label="Topics covered" />
        </Reveal>
        ...
        {hero.groupQuote ? (
          <Reveal delay={4}>
            ...
            >
              ...
              >
                {hero.groupQuote.prompt}
              </Box>
              <a
                href={hero.groupQuote.href}

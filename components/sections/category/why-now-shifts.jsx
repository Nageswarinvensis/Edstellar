  ...
  return (
    <Box>
      <Box className="grid grid-cols-1 items-start gap-5.5 lg:grid-cols-[0.82fr_1.18fr]">
        <Box role="tablist" aria-label="Shifts in enterprise AI" className="flex flex-col gap-2.5">
          {shifts.map((shift, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <ShiftIcon size={18} strokeWidth={1.7} className="text-ink" aria-hidden="true" />
                </span>
        ...
        <Box role="tabpanel" className="min-h-75 rounded-2xl border border-ink/10 bg-white p-7.5">
          <Text
            as="p"
          ...
          <Text as="p" className="mt-2 mb-5 max-w-[52ch] text-[13.5px] leading-[1.6] text-ink/60">
          ...
          >
            {renderParts(active.quote.parts, "font-display font-bold text-ink not-italic")}
          </Text>

          <Text as="span" className="mb-5 block font-mono text-[10px] tracking-[0.11em] text-ink/40 uppercase">
            Source: {active.source}
          </Text>

          <Text as="p" className="mb-5 max-w-[66ch] text-sm leading-[1.75] text-ink/60">
          ...
          <Box className="flex flex-wrap items-baseline gap-x-2.75 gap-y-2 border-t border-ink/10 pt-4.5">
            <Text as="span" className="flex-none font-mono text-[10px] tracking-[0.12em] text-ink/50 uppercase">
              Demands
            </Text>
            ...
            <Text as="span" className="font-mono text-[10px] tracking-[0.1em] text-ink/45 uppercase">

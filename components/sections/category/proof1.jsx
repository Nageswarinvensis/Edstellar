...
export default function Proof1({ data }) {
  if (!data) return null;
        ...
        <Reveal delay={1}>
          <Box className="grid grid-cols-1 items-end gap-5 lg:grid-cols-2 lg:gap-16">
            <Box>
              <Text
                as="h2"
                className="max-w-[650px] text-[36px] font-semibold leading-[0.98] tracking-[-1.8px] text-white md:text-[42px]"
              >
                {data.heading.before}{" "}
                <em className="font-serif font-normal tracking-[-1px] text-[#B8F500]">

          ...
          <Box className="mt-10 overflow-hidden rounded-[16px] border border-[#D9DDE1] bg-white">
            <Box className="grid grid-cols-1 min-[787px]:grid-cols-[300px_1fr]">
              <Box
                role="tablist"
                aria-label="Roles"
                className="flex overflow-x-auto border-b border-[#D9DDE1] min-[787px]:block min-[787px]:overflow-visible min-[787px]:border-b-0 min-[787px]:border-r"
              >
              ...
              {data.roles.map((role, index) => {
                ...
                return (
                  <Box
                    ...
                    hidden={!isActive}
                    className="min-h-0 bg-white p-5 min-[769px]:min-h-100 min-[769px]:px-10 min-[769px]:py-10"
                  >
                    <Text
                      as="span"
                    ...
                    <Box className="mt-6">
                      {role.programs?.map((program, programIndex) => (
                        <Reveal
                          as="a"
                          key={program.label}
                          href={program.href}

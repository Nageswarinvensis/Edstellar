...
export default function MapSection({ data }) {
  ...
  return (
    <Section
      as="section"
      id="why-edstellar"
      className=" w-full bg-[#F3F1E8] px-5 py-10 sm:px-8 lg:px-10 lg:py-20"
    >
      <Box>
        {/* =========================================================
            TOP / HERO
        ...
        <Box className="relative grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,1fr)_400px] lg:items-start lg:gap-12">
          ...
          <Box className="flex w-full items-start justify-center lg:justify-end">
            <Box className="relative mt-1 h-[150px] w-full max-w-[390px] overflow-hidden">
              <Image
                src={data.image.src}
                alt={data.image.alt}
                fill
        ...
        ========================================================== */}
        <Reveal delay={2}>
        <Box className="mt-11 grid overflow-hidden rounded-[14px] border border-[#D9DCE0] bg-white grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Box className="mt-9 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {data.features.map((feature, index) => (
            ...
            >
              ...
              <Text
                as="h3"
                className="mt-5 text-[18px] font-semibold leading-[1.2] --tw-tracking :-0.025em text-[#07162C]"
              >
                {feature.title}
              </Text>
        ...
        <Box className="mt-12 border-t border-[#D6D5CF] pt-8">
          ...
          <Box className="grid overflow-hidden rounded-[14px] border border-[#D9DDE1] bg-white grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            {data.relatedServices.map((service, index) => (
              ...
              >
                ...
                <Text
                  as="h4"
                  className="pr-7 text-[14px] font-medium --tw-leading: 1.25 text-[#07162C]"
                >
                  {service.title}
                </Text>
                ...
                <Text
                  as="p"
                  className="mt-2 max-w-82.5 text-[11px] --tw-leading: 1.25 text-[#6A7587]"
                >
                  {service.description}
                </Text>
              </Box>

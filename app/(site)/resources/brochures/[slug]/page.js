...
export async function generateMetadata({ params }) {
  ...
  return buildMetadata({
    title: `{name} | Brochures`,
    description: `${name} — programme details and delivery options.`,
    path: `/resources/brochures/${slug}`,
  });
}

export default async function BrochureDetailPage({ params }) {
  const { slug } = await params;

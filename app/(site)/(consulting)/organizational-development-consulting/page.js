...
export const metadata = buildMetadata({
  ...
  description:
    "Align structure, roles and capability with where the business is going, and build the operating rhythm to sustain it.",
  path: "/organizational-development-consulting",
});
function page() {
  return (
    <Section>
